...
public class DefaultCharset extends BugChecker
  ...
  private static Fix nioFileReaderFix(
          Tree arg, com.google.errorprone.bugpatterns.FileCharsetReplacementContext fileCharsetReplacementContext) {
    SuggestedFix.Builder fix = SuggestedFix.builder();
    fix.replace(
  ...
  private static Fix guavaFileReaderFix(
          Tree fileArg, com.google.errorprone.bugpatterns.FileCharsetReplacementContext fileCharsetReplacementContext) {
    SuggestedFix.Builder fix = SuggestedFix.builder();
    fix.replace(
            fileCharsetReplacementContext.getToReplace(),
        String.format(
  ...
  private static Fix nioFileWriterFix(
          Tree appendTree,
          Tree fileArg,
          boolean qualify, com.google.errorprone.bugpatterns.FileCharsetReplacementContext fileCharsetReplacementContext) {
    SuggestedFix.Builder fix = SuggestedFix.builder();
